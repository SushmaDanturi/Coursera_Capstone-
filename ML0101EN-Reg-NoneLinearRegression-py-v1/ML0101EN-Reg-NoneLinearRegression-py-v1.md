...
```
    ...
    2020-05-09 20:00:31 URL:https://s3-api.us-geo.objectstorage.softlayer.net/cf-courses-data/CognitiveClass/ML0101ENv3/labs/china_gdp.csv [1218/1218] -> "china_gdp.csv" [1]
...
```
    ...
    [<matplotlib.lines.Line2D at 0x7f1ea3346320>]
...
```
    ...
    R2-score: -1272576156390460876174393344.00
